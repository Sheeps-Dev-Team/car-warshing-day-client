...
// 지역 리스트
const Map<String, List<String>> areaMap = {
  "서울특별시": areaSeoulCategory,
  "인천광역시": areaIncheonCategory,
  "경기도": areaGyeonggiCategory,
  "강원도영동": areaKangwonYeongdongCategory,
  "강원도영서": areaKangwonYeongseoCategory,
  "충청남도": areaChungnamCategory,
  "충청북도": areaChungbukCategory,
  "세종특별자치시": areaSejongCategory,
  "대전광역시": areaDaejeonCategory,
  "경상북도": areaGyeongbukCategory,
  "경상남도": areaGyeongnamCategory,
  "대구광역시": areaDaeguCategory,
  "부산광역시": areaBusanCategory,
  "전라북도": areaJeonbukCategory,
  "전라남도": areaJeonnamCategory,
  "광주광역시": areaGwangjuCategory,
  "울산광역시": areaUlsanCategory,
  "제주특별자치도": areaJejuCategory,
};
...
//강원영동지방
const List<String> areaKangwonYeongdongCategory = [
  "강릉시",
  "고성군",
  "동해시",
  "삼척시",
...
//강원영서지방
const List<String> areaKangwonYeongseoCategory = [
  "양구군",
  "영월군",
  "원주시",
  "인제군",
